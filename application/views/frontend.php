        ...
        <div class="page-holder">
            ...
            <header class="header">
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header"><a href="frontend.php" class="navbar-brand"><img src="<?=base_url().'assets/img/logo.png'?>" alt="Italiano" width="100"></a>
                ...
                <div id="slider" class="sl-slider-wrapper">
                    ...
                    <div class="sl-slider">
                        ...
                        <div class="sl-slide bg-1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                            <div class="sl-slide-inner" style="background-image: url(<?=base_url().'assets/img/hero-bg.jpg'?>);">
                                <div class="container">
                        ...
                        <div class="sl-slide bg-2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                            <div class="sl-slide-inner" style="background-image: url(<?=base_url().'assets/img/hero-bg02.jpg'?>);">
                                <div class="container">
                        ...
                        <div class="sl-slide bg-3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                            <div class="sl-slide-inner" style="background-image: url(<?=base_url().'assets/img/hero-bg03.jpg'?>);">
                                <div class="container">
            ...
            <section id="dishes" class="dishes">
                <div class="container text-center">
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="dish">
                            <div class="profile">
                                <img src="<?=base_url().'assets/img/dish-c.png'?>" class="img-responsive" alt="dish name">
                                <div class="price">
                                    <span>17$</span>
                                </div>
                            </div>
                        ...
                        <div class="dish">
                            <div class="profile">
                                <img src="<?=base_url().'assets/img/dish-b.png'?>" class="img-responsive" alt="dish name">
                                <div class="price">
                                    <span>17$</span>
                                </div>
                            </div>
                        ...
                        <div class="dish">
                            <div class="profile">
                                <img src="<?=base_url().'assets/img/dish-a.png'?>" class="img-responsive" alt="dish name">
                                <div class="price">
                                    <span>17$</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="item">
                                ...
                                <div class="profile">
                                    <img src="<?=base_url().'assets/img/dish-d.png'?>" alt="dish name" class="img-responsive">
                                </div>
                                <div class="text">
                                    <h4>Dish Name</h4>
            ...
            <section id="events" class="events">
                <div class="container">
                    ...
                    <div class="row">
                        <!-- Profile Side  -->
                        <div class="col-sm-6">
                            <div class="profile has-border" style="background-image: url(<?=base_url().'assets/img/event-bg.jpg'?>);">
                    ...
                    <div class="gellery">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg01-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg01.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg02-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg02.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg03-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg03.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg05-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg05.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg06-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg06.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg04-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg04.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6 col-custom-12">
                                <div class="item">
                                    <img src="<?=base_url().'assets/img/bg07-small.jpg'?>" alt="image">
                                    <a href="<?=base_url().'assets/img/bg07.jpg'?>" data-lightbox="image-1" data-title="Image Caption" class="has-border">
                                        <span class="icon-search"></span>
                                    </a>
                                </div>
                            </div>
